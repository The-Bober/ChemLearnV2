  ...
  { 
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: (mockQuizzesData[0]?.questions[1]?.options.find(opt => opt.text === 'Solid') || {id: ''}).id, // dynamically get id
...
if (mockQuizzesData[0] && mockQuizzesData[0].questions[1] && mockQuizzesData[0].questions[1].options) {
