...
const lectures = [
  { id: "1", title: "Introduction to Chemistry", description: "Basics of matter, atoms, and molecules.", lessons: 5, imageHint: "chemistry textbook" },
  { id: "2", title: "Atomic Structure", description: "Understanding protons, neutrons, and electrons.", lessons: 8, imageHint: "atom model" },
  { id: "3", title: "Chemical Bonding", description: "Ionic, covalent, and metallic bonds.", lessons: 10, imageHint: "molecular structure" },
  { id: "4", title: "Stoichiometry", description: "Calculations involving chemical reactions.", lessons: 7, imageHint: "chemical equation" },
];
          ...
          {lectures.map((lecture) => (
            <Card key={lecture.id} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="p-0">
                <Image 
                  src={`https://picsum.photos/600/400?random=${lecture.id}`} 
                  alt={lecture.title}
                  width={600}
                  height={400}
                  className="object-cover w-full h-48"
                  data-ai-hint={lecture.imageHint}
                />
              </CardHeader>
